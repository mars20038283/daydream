package com.marswork.investment.futures.policy.tradeopenvariable.printer;
...
import com.marswork.investment.futures.policy.tradeopenvariable.TradeGeYe;
...
public class TradeListSheetCreator {
	...
	public static void createTradeListSheet(VirtureAccount account,
			Sheet sheet, List<Trade> tradeRecoreds, TradeGeYe policy)
		...
		for (int i = 0; i < tradeRecoreds.size(); i++) {
			...
			data.createCell(16).setCellValue(
					NumberUtils.formatNumber(huiluo - 100));
